...
//   if (profileImage) {
//     return (
//       <img src={profileImage} alt={name} style={{
...
//               <Avatar name={c.user?.name} profileImage={c.user?.profileImage} size={28} />
...
//             }}>
//               {isOwner && (
//                 <button onClick={() => { setShowMenu(false); onDelete(post._id); }} style={{

...
import NotificationPanel from "./dashboard/notification.jsx";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/85 backdrop-blur-lg border-b border-purple-500/20">
        ...
        <div className="h-16 flex items-center px-4 md:px-6 gap-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            {/* Notifications bell — opens slide-in panel */}
            <div
              className={`relative w-9 h-9 rounded-xl border border-white/10 flex items-center justify-center cursor-pointer transition-all
                ${showNotifications
                  ? "bg-purple-900/40 text-purple-400 border-purple-500/40"
                  : "text-gray-400 hover:bg-purple-900/40 hover:text-purple-400"
                }`}
      ...
      {/* Notification slide-in panel — rendered outside <nav> to cover full screen */}
      {showNotifications && (
